...
const navigation = {
  main: [
    ...
    { name: "Terciario", href: "/terciario" },
    { name: "Nosotros", href: "/nosotros" },
  ],
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/Institutolasnieves",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/institutolasnieves/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/instlasnieves",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "GitHub",
      href: "https://github.com/LasNieves",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer className="bg-Blanco dark:bg-PseudoNegro">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-center text-base text-GrisClaro">
          &copy; 2021 NovoFaciem, 5To Informática.
        </p>
      </div>
    </footer>
  );

              ...
              <div className="relative px-8">
                ...
                <blockquote className="mt-8">
                  ...
                  <footer className="mt-4">
                    <p className="text-base font-semibold text-VerdeAgua">Sarah Williams, CEO at Workcation</p>
                  </footer>
                </blockquote>
              </div>
            </div>
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="mt-10">
            <dl className="grid grid-cols-2 gap-x-4 gap-y-8">
              {stats.map((stat) => (
                <div key={stat.label} className="border-t-2 border-Blanco pt-6">
                  <dt className="text-base font-medium text-GrisPlata">{stat.label}</dt>
                  <dd className="text-3xl font-extrabold tracking-tight text-SemiNegro dark:text-Gris">{stat.value}</dd>
                </div>
              ))}
            </dl>
            <div className="mt-10">
              <a href="#" className="text-base font-medium text-Turquesa">
                {' '}
